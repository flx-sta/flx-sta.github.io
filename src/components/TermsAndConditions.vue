  ...
  <div class="text-black">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Felix Pütz.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Felix Pütz, accessible from
          <a
            href="https://felix-puetz.com"
            rel="external nofollow noopener"
            target="_blank"
            >https://felix-puetz.com</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        By email:
        <a
          href="mailto:fpuetz@gmx.net?subject=Contact via felix-puetz.com"
          target="_blank"
          >fpuetz@gmx.net</a
        >
      </li>
